          ...
          <div class="card mb-4 shadow text-white">
            ...
            <div class="">
              <div class="card mb-4 shadow">
                <div class="card-body">
                  <p>Selamat datang di sistem Keamanan Lingkungan. Melalui aplikasi ini, warga dapat melihat jadwal ronda, melaporkan kejadian, dan mendapatkan informasi penting seputar keamanan. Mari bersama-sama menjaga lingkungan agar tetap aman, nyaman, dan kondusif.</p>
                </div>
              </div>
            </div>
            <?php
