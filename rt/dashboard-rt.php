        ...
        <div class="container-fluid px-4">
          ...
          <div class="card mb-4 shadow text-white">
            <div class="card-body rounded-3" style="background: linear-gradient(160deg, #0f1724 0%, #4c1d95 40%, #e66465 70%, #45d0b6 100%);">
              <h3>Selamat Datang, <?php echo htmlspecialchars($_SESSION['nama']); ?>
                😎</h3>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card shadow border-0">
                <div class="card-body d-flex align-items-center">
                  ...
                  <div>
                    <h4 class="mb-0 fw-bold"><?= $totalLaporan ?></h4>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card shadow border-0">
                <div class="card-body d-flex align-items-center">
                  ...
                  <div>
                    <h4 class="mb-0 fw-bold"><?= $totalWarga ?></h4>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card shadow border-0">
                <div class="card-body d-flex align-items-center">
                  ...
                  <div>
                    <h4 class="mb-0 fw-bold"><?= $menunggu ?></h4>
